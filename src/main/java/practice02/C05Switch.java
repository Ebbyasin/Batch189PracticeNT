...
public class C05Switch {
    public static void main (String [] args){
        ...
        */
        ...
        String seviye="";// if else disinda da kullanabilmek icin seviyeyi if else den once
        // olusturuyoruz
        ...
        switch (seviye){
            ...
            default:
                System.out.println("Sinava puaninizi dogru giriniz");
        }
