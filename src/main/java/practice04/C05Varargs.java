...
public class C05Varargs {
    ...
    public static void main(String[] args) {
        ...
        enUzunKelime(str1,str3,str4,str2); // str4 e kadar koyarsak en uzun kelime
                                          // ahmet olur,cunku melek in harf sayisi
                                        // da 5,ahmet inkinden buyuk olmadigi icin
                                        // en uzun kelime degismez
    }
